...
const skillsValue = [
  {
    ...
    imgList: [
      ...
      { img: "./images/skills/jquery.png", width: "90%" },
  ...
  },
  {
    ...
    imgList: [
      ...
      { img: "./images/skills/Amazon.png", width: "90%" },
    ],
  },
  {
    title: "Version Control",
    imgList: [
      { img: "./images/skills/git.png", width: "80%" },
    ...
    <Layout page={"skills"}>
      <section class="text-gray-600 body-font overflow-hidden">
        <div class="container px-5 mx-auto relative">
          <div class="flex flex-wrap flex-col content-around -m-4 h-full lg:h-[850px] md:h-[1300px] mb-2 md:mb-0">
            {skillsValue.map((e) => (
